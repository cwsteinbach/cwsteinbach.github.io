...
The resource generally in shortest supply in a software development environment is time. It’s not surprising then that unrealistic scheduling is one of the greatest sources of conflict between technical staff and their management. Please keep this in mind - successful scheduling is a process of negotiation, not dictation. Nobody knows more about how long a particular task will take to complete than the person who is to complete it. Your team has the right to be consulted on the scheduling of those tasks they are responsible for, and to be able to meet their commitments without undue stress or hardship.
...
### Great Mistakes in Technical Leadership {#great-mistakes-in-technical-leadership}
...
### The Architecture Group {#the-architecture-group}
...
## Extreme Programming and Agile Methods {#extreme-programming-and-agile-methods}


### Extreme Deprogramming {#extreme-deprogramming}
...
### New Methodologies or New Age Methodologies? {#new-methodologies-or-new-age-methodologies}
...
### Rhetorical AntiPatterns in XP {#rhetorical-antipatterns-in-xp}
...
### The Deflowering of a Pair Programming Virgin {#the-deflowering-of-a-pair-programming-virgin}
...
### XP and ESP: The Truth is Out There! {#xp-and-esp-the-truth-is-out-there}
...
### Thought Leaders and Thought Followers -- Fowler On "Appeals To Authority" {#thought-leaders-and-thought-followers-fowler-on-appeals-to-authority}
...
### Dude, Where’s My Spacecraft? {#dude-where-s-my-spacecraft}
...
### User is a Four Letter Word {#user-is-a-four-letter-word}
...
### The Folly of Emergent Design {#the-folly-of-emergent-design}
...
public static final NormYearLevel NORM\_YEAR\_1 =
new NormYearLevel(1);
public static final NormYearLevel NORM\_YEAR\_12 =
...
### The Top Ten Elements of Good Software Design {#the-top-ten-elements-of-good-software-design}
...
### Oral Documentation: Not Worth the Paper it’s Written On {#oral-documentation-not-worth-the-paper-it-s-written-on}
...
### FUDD: Fear, Uncertainty, Doubt and Design Documentation {#fudd-fear-uncertainty-doubt-and-design-documentation}
...
### Get Your Filthy Tags Out of My Javadoc, Eugene {#get-your-filthy-tags-out-of-my-javadoc-eugene}
...
### Naming Classes: Do it Once and Do it Right {#naming-classes-do-it-once-and-do-it-right}
...
### In Praise of Code Reviews {#in-praise-of-code-reviews}
...
### Web Accessibility for the Apathetic {#web-accessibility-for-the-apathetic}
...
### Spare a Thought for the Next Guy {#spare-a-thought-for-the-next-guy}
...
### Six Legacy Code AntiPatterns {#six-legacy-code-antipatterns}
...
### Basic Critical Thinking for Software Developers {#basic-critical-thinking-for-software-developers}
...
### Anecdotal Evidence and Other Fairy Tales {#anecdotal-evidence-and-other-fairy-tales}
...
### Function Points: Numerology for Software Developers {#function-points-numerology-for-software-developers}
...
### Programming and the Scientific Method {#programming-and-the-scientific-method}
...
### From Tulip Mania to Dot Com Mania {#from-tulip-mania-to-dot-com-mania}
...
### The Crooked Timber of Software Development {#the-crooked-timber-of-software-development}
...
### IEEE Software Endorses Plagiarism {#ieee-software-endorses-plagiarism}
...
### Early Adopters or Trend Surfers? {#early-adopters-or-trend-surfers}
...
JSP 1998 EJB 1998 .NET 2002 Java 1995 J2EE 1999 SOAP 2000 Microsoft Windows 1993 GUI 1974
Now consider the following software development practices:
Practice
Source code control Inspections
...
Practice
First Noted
279 EARLY ADOPTERS OR TREND SURFERS?
Software Metrics 1977 Throwaway UI prototyping 1975 Information Hiding 1972 Risk Management 1981
...
### Reuse is Dead. Long Live Reuse. {#reuse-is-dead-dot-long-live-reuse-dot}
